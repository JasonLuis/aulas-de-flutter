...
class UpadateLogin extends StatefulWidget {
  UpadateLogin({
    Key key,
...
class _UpdateLoginState extends State<UpadateLogin> {
          ...
          child: Center(
            child: ListView(
              children: <Widget>[
                ...
                TextFormField(
                  // autofocus: true,
                  initialValue: UsuarioModel.usuarioModel.nome,
                ...
                TextFormField(
                  // autofocus: true,
                  initialValue: UsuarioModel.usuarioModel.email,
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () {
                        if (formKey.currentState.validate()) {
                          ...
                          var mensagem = UsuarioModel.usuarioModel.nome +
                              ' editado com sucesso!';
                          usuarioModel.idUsuario =
                              UsuarioModel.usuarioModel.idUsuario;
